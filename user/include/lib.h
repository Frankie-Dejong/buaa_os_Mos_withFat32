...
// for Fat32 FS
int fsipc_open_Fat32(const char *, u_int, struct Fd *);
int fsipc_map_Fat32(u_int, u_int, void *);
int fsipc_set_size_Fat32(u_int, u_int);
int fsipc_close_Fat32(u_int);
int fsipc_dirty_Fat32(u_int, u_int);
...
int syscall_ipc_try_broadcast(struct Env * tenvs, u_int val, void * srcva, u_int perm);
...
#define FAT32ROOT FAT
#define MAXWB (BY2PG - 3 * sizeof(u_int))
